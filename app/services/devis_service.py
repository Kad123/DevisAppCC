...
from app.models.devis import Devis, DevisCreate, DevisUpdate, LotDevis, LignePoste, Facture
...
def get_all_devis(db: Session, skip: int = 0, limit: int = 100, statut: Optional[str] = None):
...
def create_facture(db: Session, devis_id: int) -> Facture:
    ...
    db_facture = Facture(
        devis_id=devis_id,
        numero_facture=generate_facture_number(db),
