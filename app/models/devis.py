...
class Devis(Base):
    ...
    lots = relationship("LotDevis", back_populates="devis", cascade="all, delete-orphan")
...
class LotDevis(Base):
    ...
    lignes_poste = relationship("LignePoste", back_populates="lot", cascade="all, delete-orphan")
