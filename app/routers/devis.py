...
from app.models.devis import DevisCreate, DevisUpdate, DevisResponse, FactureCreate, FactureResponse
...
# --- 2. GÉNÉRATION PAR IA ---
@router.post("/generate", response_model=DevisResponse, status_code=status.HTTP_201_CREATED)
...
@facture_router.post("/", response_model=FactureResponse, status_code=status.HTTP_201_CREATED)
